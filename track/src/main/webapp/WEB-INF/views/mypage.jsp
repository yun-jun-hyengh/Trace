...
<header class="masthead text-black text-center">
	...
	<div class="container">
  		<span style="float: right;">
	        <a class="btn" style="background-color: #04B404" href="${cpath}/memberview/">내정보</a><br><br>
	        <a class="btn" style="background-color: #04B404" href="${cpath}/diary/diarylist">반려동물</a><br><br>
	        <a class="btn" style="background-color: #04B404" href="${cpath}/memberdelete/">회원탈퇴</a><br><br>
	    </span>	
